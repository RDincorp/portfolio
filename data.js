...
const PROFILE_DATA = {
  ...
  aboutBio: "Младший научный сотрудник Центра политологии Института социологии НАН Беларуси. Выпускник магистратуры кафедры политологии юридического факультета Белорусского государственного университета (Минск).",
