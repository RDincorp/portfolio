...
const PROFILE_DATA = {
  ...
  analyticalStack: [
    { name: "Количественные и качественные методы", tools: "Комплексный подход к сбору, верификации и обработке эмпирических данных" },
    { name: "ИИ-инструменты для расчётов", tools: "Применение современных нейросетей и алгоритмов в аналитической работе" },
    { name: "Дискурс-анализ и контент-анализ", tools: "Анализ текстовых массивов, медиаповестки и публичных документов" },
    { name: "Статистический и корреляционный анализ", tools: "Математическая обработка и выявление статистических зависимостей" },
    { name: "SWOT-анализ", tools: "Оценка внешних и внутренних факторов, рисков и возможностей" },
    { name: "Наблюдение и сводка", tools: "Полевые социологические методы, систематизация и структурирование данных" }
  ],
  stats: {
    conferencesCount: "10",
    memosCount: "5",
