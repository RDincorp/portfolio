...
const PROFILE_DATA = {
  ...
  analyticalStack: [
    { name: "Методы", tools: "Количественные и качественные методы, ИИ-инструменты для проведения расчётов. Дискурс-анализ, контент-анализ, SWOT, статистический анализ, наблюдение и сводка, корреляции" }
  ],
  stats: {
    conferencesCount: "10",
    memosCount: "5",
