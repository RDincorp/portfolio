...
const PROFILE_DATA = {
  ...
  analyticalStack: [
    { name: "Количественные и качественные методы", tools: "" },
    { name: "Дискурс-анализ и контент-анализ", tools: "" },
    { name: "Статистический и корреляционный анализ", tools: "" },
    { name: "SWOT-анализ", tools: "" },
    { name: "Наблюдение и сводка", tools: "" },
    { name: "ИИ-инструменты для расчётов", tools: "" }
  ],
  stats: {
    conferencesCount: "10",
    memosCount: "5",
...
const PORTFOLIO_ITEMS = [
  ...
  },
  {
    ...
    details: {
      ...
      url: "https://bisr.gov.by/provedyonnye-meropriyatiya/luchshie-molodezhnye-proekty-vybrali-v-belorusskom-institute"
    }
  },
  {
    id: "work-10",
